...
tags: [computational-creativity, creative-coding, critical-computing, art-science, participatory]
...
- Faculty include rotating artists and engineers from the NYC computational art community

## For Amber
- **Apply as participant or faculty** — SFPC is small and selective but open to artists working at the intersection of code + critical thinking. Amber's profile fits.
- **Workshop proposal** — the alt-AI workshop at SFPC (where Levin spoke) shows they welcome critical AI discourse
- **Community** — SFPC alumni are a tight network; engaging with them opens NYC's computational art community

## Why Interesting
SFPC occupies a unique position: technically rigorous (students learn C++, circuits, etc.) but explicitly political and poetic. It's the closest thing to an art school that takes computation seriously as a medium for critique. Strong queer, feminist, and decolonial currents in its faculty and alumni.
