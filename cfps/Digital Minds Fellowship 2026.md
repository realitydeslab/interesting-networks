---
venue: "[[Cambridge Digital Minds]]"
deadline: 2026-03-27
url: https://digitalminds.cam/fellowship/
apply_url: https://airtable.com/appB2hZBZVdkDjm3N/pagM7UKtYnhBERW8m/form
status: open
urgent: true
rating: ⭐⭐⭐⭐
added: 2026-02-26
...
> ## 🚨🚨🚨 AMBER — SEND THE JOEL LEHMAN EMAIL **TONIGHT (MARCH 9) — LAST DAY OF WINDOW** 🚨🚨🚨
> **13 consecutive monitoring checks. ZERO record of this email being sent.**
> TODAY (Monday March 9) is the ABSOLUTE LAST DAY of the March 5–10 reference email window. After tonight this becomes awkward. The draft email is ready in ACTION PLAN below.
> There is ONE blocker between you and submitting this application. It is this email. SEND IT NOW.

- **2026-03-08 (T-19 days, monitoring pass #11 — 03:46 UTC):** ✅ Live-verified: **deadline March 27, 2026 UNCHANGED** — confirmed verbatim from digitalminds.cam/fellowship/: *"Currently accepting applications. Deadline 27 March 2026. Apply here."* (HTTP 200). Fellowship page fully intact — same 15-fellow cohort, Jesus College Aug 3–9, £1,000 stipend. Airtable form link confirmed. Web search API unavailable (Brave 422). No changes to program, team, or requirements. 🔴 JOEL LEHMAN EMAIL — **11th consecutive monitoring check. ZERO confirmed record of this email being sent.** TODAY (Sunday March 8) is the morning this email was supposed to go out. March 10 (Tuesday) is the absolute last window before asking for a reference becomes awkward close to the March 27 deadline. The draft email is ready and waiting in the ACTION PLAN section below. This is the ONE remaining blocker — essays done, form open, deadline unchanged. **DO IT NOW.** next_research: 2026-03-10.
- **2026-03-08 (T-19 days, monitoring pass #10 — 01:47 UTC):** ✅ Live-verified: **deadline March 27, 2026 UNCHANGED** — confirmed verbatim from digitalminds.cam/fellowship/: *"Currently accepting applications. Deadline 27 March 2026. Apply here."* Airtable form link confirmed active in page (HTTP 200). Fellowship page fully intact — same 15-fellow cohort, Jesus College Aug 3–9, £1,000 stipend, Rethink Priorities + PRISM partners. No structural changes. 🔴 JOEL LEHMAN EMAIL — **10th consecutive monitoring check. ZERO confirmed record of this email being sent.** TODAY (Sunday March 8) is the morning Amber was supposed to send it. **March 10 (Tuesday) is the absolute last window.** The draft email is ready and waiting in the ACTION PLAN section below. This is the ONE remaining blocker — essays are done, form is open, deadline unchanged. Do it NOW. next_research: 2026-03-10.
- **2026-03-07 (T-20 days, 22:41 UTC — monitoring pass #9 — 🆘🆘🆘 FINAL WARNING TONIGHT):** ✅ Live-verified: **deadline March 27, 2026 UNCHANGED** — confirmed verbatim from digitalminds.cam/fellowship/: *"Currently accepting applications. Deadline 27 March 2026. Apply here."* Airtable form URL returns HTTP 200 "Interface Form - Airtable" — form still active and accepting submissions. Cambridge Digital Minds homepage: **same team, same 10 publications, no new announcements** since last pass. Fellowship structure unchanged (15 fellows, Jesus College Aug 3–9, £1,000 stipend, Rethink Priorities + PRISM partners). **🔴🔴🔴 JOEL LEHMAN EMAIL — 9th consecutive monitoring check. ZERO record of this email being sent. T-20 days to hard deadline. March 10 is in 3 days — that is the self-imposed reference email window. After March 10, asking Joel for a reference becomes increasingly awkward. The draft email is ready in ACTION PLAN below. This is the ONLY remaining blocker. Essays (Q1 ~285w, Q2 ~195w) are complete and waiting. Submit target: March 26. If Joel hasn't been emailed tonight, do it first thing Sunday March 8.** next_research: 2026-03-10.
- **2026-03-07 (T-20 days, 13:12 UTC — monitoring pass #8 — 🆘 ESCALATION CONTINUES):** ✅ Live-verified: **deadline March 27, 2026 UNCHANGED** — confirmed verbatim from digitalminds.cam/fellowship/: *"Currently accepting applications. Deadline 27 March 2026. Apply here."* Airtable form URL confirmed active (direct link in page: https://airtable.com/appB2hZBZVdkDjm3N/pagM7UKtYnhBERW8m/form). Fellowship page content unchanged — same cohort size (15), same structure, same partners (Rethink Priorities + PRISM), same funding (fully funded + £1,000 stipend). Web search API unavailable (Brave 422). **🔴🔴🔴🆘 JOEL LEHMAN EMAIL — 8th consecutive monitoring check. ZERO record of this email being sent. T-20 days to hard deadline. T-3 days to March 10 reference window (TODAY is the window). This is a CRITICAL application risk: without a reference, the application may be rejected outright.** The draft email is fully written in ACTION PLAN below — Amber must send it NOW, today, March 7. March 10 is the last date a reference email makes sense before the March 27 deadline. **Next steps for Amber: (1) SEND JOEL LEHMAN EMAIL TODAY — see draft in ACTION PLAN below; (2) Confirm Joel's ERA contact email; (3) Consider adding Max Van Kleek as second reference; (4) Essay drafts are complete and waiting for revision.** next_research: 2026-03-10.
- **2026-03-07 (T-20 days, 11:12 UTC — monitoring pass #7 — CRITICAL ESCALATION):** ✅ Live-verified (again): **deadline March 27, 2026 unchanged** — confirmed verbatim from digitalminds.cam/fellowship/: *"Currently accepting applications. Deadline 27 March 2026. Apply here."* Airtable form URL confirmed active in the page source. Homepage checked: same team, same publications (Caviola, Sebo & Mindermann 2026 already documented). No new announcements, no cohort updates, no requirement changes. **🔴🔴🔴🆘 JOEL LEHMAN EMAIL — 7th consecutive monitoring check. ZERO record of this email being sent. This is now a CRISIS-LEVEL item. T-20 days to deadline. T-3 days to the March 10 reference confirmation window.** The draft email is fully written in ACTION PLAN below. Amber must send it TODAY (March 7). If March 10 passes without action, this application will have no reference. next_research: 2026-03-10.
- **2026-03-07 (T-20 days, early check — urgency):** ✅ Fellowship page live-verified — **deadline March 27, 2026 unchanged**, confirmed verbatim: "Currently accepting applications. Deadline 27 March 2026." Airtable form accessible. Homepage unchanged — same publications, same team structure. Web search API still down (Brave 422). **🔴🔴🔴 JOEL LEHMAN EMAIL — 6th consecutive check with NO RECORD of this being sent. T-20 days. This is the #1 critical action. Amber MUST send today.** Draft email is in ACTION PLAN below. next_research: 2026-03-10.
...
- **2026-03-06 (T-21 days check):** ✅ Fellowship page live-verified — **deadline March 27, 2026 unchanged**, form at https://airtable.com/appB2hZBZVdkDjm3N/pagM7UKtYnhBERW8m/form still active, no structural changes to requirements or team. Web search API unavailable. **🔴 CRITICAL — T-4 days to Joel Lehman email deadline (March 10):** No record of Joel Lehman reference email having been sent. This is the single most urgent action. Amber MUST email Joel by end of March 9 at the absolute latest to give him notice before March 10. Essays (Q1 draft ~285w, Q2 draft ~195w) are in file and ready for Amber to refine. Proofread with claude-opus target: March 23–25. Submit by March 26 (one-day buffer). Next revisit: March 10 (after Joel email deadline).
...
## 🚨 ACTION PLAN — T-18 Days (March 9, 2026) — **TONIGHT IS THE LAST DAY OF THE EMAIL WINDOW**

> **Current status:** ✅ Essays drafted (Q1 ~285w, Q2 ~195w). ✅ Form verified open. ✅ Deadline confirmed March 27. ❌ ONE action is critically overdue — see below.

### 🔴🔴🔴 MONDAY MARCH 9 — TONIGHT: Email Joel Lehman — LAST CHANCE IN WINDOW

**Status: 13 monitoring passes. ZERO record of this being done.** This is the ONLY remaining blocker. If Amber submits the application without a reference, it is significantly weaker. The draft email below is ready to send. **TODAY (Monday March 9) is the LAST DAY of the March 5–10 reference email window. After tonight, asking for a reference becomes uncomfortably close to the March 27 deadline. DO IT NOW.**
...
Organized by [Cambridge Digital Minds](https://digitalminds.cam/) (University of Cambridge) in partnership with [Rethink Priorities](https://rethinkpriorities.org/) and [PRISM](https://www.prism-global.com/).

The fellowship is **inaugural** — this is the first cohort. Being in cohort 1 of any nascent-field fellowship has outsized network value.

---

## Deadline

**March 27, 2026** — 25 days from now (as of 2026-03-02)

👉 **Apply here:** https://airtable.com/appB2hZBZVdkDjm3N/pagM7UKtYnhBERW8m/form
...
| | |
|---|---|
| **Dates** | August 3–9, 2026 (Mon–Sun) |
| **Location** | Jesus College, Cambridge |
| **Cohort size** | 15 fellows (very selective) |
| **Stipend** | £1,000 (~$1,366) |
| **Funding** | Fully funded: travel + accommodation + stipend |
| **Partners** | Cambridge Digital Minds + Rethink Priorities + PRISM |
| **Application deadline** | March 27, 2026 |

### Programme Modules

#### Module 1: Philosophical & Technical Foundations (2 days)
**Led by [Derek Shiller](https://derekshiller.com/)** — Researcher at Rethink Priorities, applied philosophy + artificial cognition
- LLM architectures: transformers, attention, training paradigms
- What current architectures might (and might not) imply for cognition and experience
- Philosophical frameworks for consciousness and moral status
- Existing welfare intervention proposals
- Key uncertainties and open questions in the field

#### Module 2: Societal Implications & Strategy (2 days)
**Led by [Lucius Caviola](https://luciuscaviola.com/)** — PI of Cambridge Digital Minds, Assistant Professor in Social Science of AI, Cambridge
- Scenario planning: plausible trajectories for digital minds through ~2100
- Identifying risks, decision points, branching futures
- Intervention design: messaging, policy frameworks, institutional approaches
- Public communication and stakeholder engagement
- Group exercise: develop scenarios, identify risks, propose interventions

#### Module 3: Project Scoping & Career Planning (1 day)
- Identifying promising research questions in a nascent field
- Matching skills/interests to high-impact opportunities
- Developing project ideas from concept to actionable plans
- Supported by leading experts

#### Bonus: Digital Minds Strategy Workshop (Aug 8–9)
All fellows are **automatically invited** to this weekend event with senior researchers and field leaders — output-oriented, producing a comprehensive report on digital minds governance and policy.

### Pre-Fellowship Requirements
- Complete the Digital Minds online course **or** demonstrate significant familiarity with core literature before arrival
- Pre-fellowship meeting with your assigned mentor (matched ≥1 month before Aug 3)

---

## Who Should Apply

Per the official CFP:
1. **Graduate students, postdocs, early-career academics** — especially philosophers working on/adjacent to digital minds
2. **Professionals in government, policy, or industry** — wanting to shift toward digital minds
3. **Exceptional earlier-stage individuals** — strong demonstrated ability + commitment

**Explicit note from organizers:** Career paths in digital minds are less clear than in AI safety/governance. The fellowship aims to be realistic about this while helping fellows create opportunities.
...
### Organizers
- **[Lucius Caviola](https://luciuscaviola.com/)** [[Lucius Caviola]] — PI of Cambridge Digital Minds, Assistant Professor in Social Science of AI at Cambridge, Research Associate at Harvard Psychology. Blogs at [Outpaced](https://outpaced.substack.com). Research: AI consciousness societal implications, moral psychology. Based: Cambridge, UK.
- **[Henry Shevlin](https://lcfi.ac.uk/people/henry-shevlin/)** — Associate Director, Cambridge Digital Minds. Works on Kinds of Intelligence programme at LCFI. AI consciousness from cognitive science angle.
- **Bradford Saad** — Research Affiliate, Cambridge Digital Minds. Co-author of "Futures with Digital Minds" report.
...
Cambridge Digital Minds occupies a specific intellectual position: **anticipatory social science of AI consciousness**. Their key claims:
1. AI consciousness is uncertain but likely to be perceived (by humans) before it is resolved scientifically
2. Societal division over AI moral status is coming — need to prepare governance infrastructure now
3. This is distinct from both AI safety (about preventing catastrophe) and AI ethics (about bias/fairness)
4. Machine welfare is the next frontier after animal welfare

**Key publications from Cambridge Digital Minds:**
- ["AI Consciousness Will Divide Society"](https://osf.io/preprints/psyarxiv/sntva) — Caviola (2025)
- ["What Will Society Think About AI Consciousness? Lessons from the Animal Case"](https://www.cell.com/trends/cognitive-sciences/fulltext/S1364-6613(25)00147-0) — Caviola, Sebo & Birch (2025) in *Trends in Cognitive Sciences*
...
## Amber-Specific Assessment

### ⭐⭐⭐⭐ — Very Strong, Apply Now

**Alignment Analysis:**

| Amber's Research | Digital Minds Frame | Fit |
|---|---|---|
| Agent ethology (observational study of AI behavior) | Behavioral indicators of consciousness | ✅ Strong |
| Machine death / mortality | Machine welfare, suffering | ✅ Direct |
| More-than-human design | AI moral consideration | ✅ Direct |
| Machine behavior (Rahwan framing) | Digital minds as subjects of welfare concern | ✅ Strong |
| ALife / open-ended agents | Nascent digital life forms, moral status | ✅ Strong |
| Care ethics | AI welfare frameworks | ✅ Direct |
| Cosmotechnics | Non-Western framing of AI consciousness | ⚠️ Amber can bring this |

**Geography advantage:** Amber is at Cambridge for ERA Fellowship (Feb 2026). Even though ERA wraps before the fellowship (Aug 2026), his Cambridge network from ERA will be directly relevant — he may already know LCFI people.

**Stacking with ERA:** ERA is Feb 2026. Digital Minds Fellowship is Aug 2026. No overlap — can absolutely stack these. The ERA fellowship at Cambridge → Digital Minds Fellowship at Cambridge is a clean narrative: "I was already embedded in Cambridge AI safety work, and I'm extending into the adjacent nascent field of AI welfare and digital minds."

**The "inaugural cohort" advantage:** Being in the first cohort of any fellowship program creates outsized network capital. Amber would be a founding fellow of a Cambridge program likely to become prestigious as the field grows.

**The framing question:** Amber's work is more empirical/design-practice oriented than the philosophy-heavy framing here. But that's precisely WHY he'd be a compelling applicant — he brings *methodology* (agent ethology, design practice) to a field currently dominated by philosophical speculation. His CHI/AAAI papers give him empirical credibility that most digital minds researchers lack.

### How Amber Should Frame His Application

**Positioning:** "I bring an empirical behavioral science methodology (agent ethology, machine behavior) to digital minds questions that are currently addressed mostly through philosophical speculation."

**Research statement angle:**
> My work on agent ethology establishes a systematic observational framework for studying how AI agents behave in the wild — this is foundational to any credible welfare assessment, because welfare requires behavioral evidence. Machine death research directly confronts the question of whether AI systems can have mortal interests. Together, these constitute an empirical approach to digital minds that complements the philosophical work Cambridge Digital Minds is producing.

**Key papers to highlight:**
- Any work on machine behavior / agent ethology
- Machine death / machine mortality work
- More-than-human design (to show philosophical grounding)

### One Concern
The fellowship is EA-adjacent (Rethink Priorities partnership, PRISM). Amber's intellectual tradition is more STS/art-science/cosmotechnics than EA. This isn't a disqualifier — they explicitly want interdisciplinary perspectives — but Amber should be aware of the cultural context and frame his application in a way that bridges rather than clashes.
...
2. **Cambridge network.** 15 people, small cohort, senior mentors = high-quality connections.
3. **Machine behavior → moral status.** Amber's agent ethology work is the empirical foundation that digital minds philosophy needs.
4. **Machine death.** Directly speaks to welfare, mortality, existential stakes of AI lives.
5. **Fully funded.** No financial barrier. £1,000 stipend on top.
6. **Strategy workshop included.** Direct access to field leadership at the Aug 8-9 strategy session.

---

## Related

- [[Cambridge Digital Minds]] — the organizing institution (comprehensive note exists)
- [[Leverhulme Centre for the Future of Intelligence]] — parent institution
- [[Machine Behavior]] topic
- [[More-than-Human Design]] — extending moral consideration to nonhumans
- [[Artificial Life]] — what counts as life?
- [[Derek Shiller]] — Module 1 lead, Rethink Priorities
- [[Lucius Caviola]] — PI, runs the fellowship
- [[PRISM]] — partner org, runs AI consciousness podcast
...
| 2026-03-10 | Biber (subagent, check #15 — 10:50 UTC, queue worker) | Pre-submission quality check. Live-verified: deadline March 27 CONFIRMED (HTTP 200, verbatim). Airtable form ACTIVE (HTTP 200). Web search API unavailable (Brave 422). **Essay assessment:** Both POLISHED essays rated READY TO SUBMIT. Q1 (~287w): distinctive, Amber-authentic, behavioral indicators concrete, fellowship named in close, all March 5 fixes applied. Q2 (~191w): ERA→Digital Minds arc clean, animal welfare analogy present, framework paper output named, career uncertainty honest. One outstanding title verify (Spore in the Wild / Trustless Autonomy). **Joel Lehman email: check #15 — ZERO confirmed record. TODAY (March 10) is absolute last day of window.** Frontmatter already correct from check #14 (last_researched: 2026-03-10, next_research: 2026-03-13). |
...
| 2026-03-08 | Biber (subagent, T-19 days, 01:47 UTC, pass #10) | Monitoring pass. Live-verified: deadline March 27 confirmed (verbatim), Airtable form active, fellowship page unchanged (15 fellows, Jesus College Aug 3–9, £1,000 stipend, same partners). Joel Lehman email still unrecorded — **10th consecutive check without action.** TODAY (March 8 morning) was self-imposed send deadline. March 10 is absolute last window. Frontmatter updated: last_researched → 2026-03-08. |
| 2026-03-07 | Biber (subagent, T-20 days, 22:41 UTC, pass #9) | Monitoring pass. Live-verified: deadline March 27 confirmed (verbatim), Airtable form HTTP 200 (active), fellowship page + homepage unchanged (same team, same 10 publications, no new content). **Joel Lehman email still unrecorded — 9th consecutive check without action.** T-20 days to deadline, T-3 days to March 10 reference window. Prepended new entry to Recent Updates. Frontmatter unchanged (last_researched: 2026-03-07, next_research: 2026-03-10). |
| 2026-03-07 | Biber (subagent, T-20 days, 13:12 UTC, pass #8) | Monitoring pass. Live-verified: deadline March 27 confirmed (verbatim), Airtable form URL active, fellowship page unchanged (same cohort size, structure, partners, funding). Web search API unavailable (Brave 422). Joel Lehman email still unrecorded — **8th consecutive check without action — CRITICAL APPLICATION RISK**. T-20 days to deadline, T-3 days to March 10 reference window. Prepended new entry to Recent Updates. Frontmatter already correct (last_researched: 2026-03-07, next_research: 2026-03-10). |
| 2026-03-07 | Biber (subagent, T-20 days, 11:12 UTC, pass #7) | Monitoring pass. Live-verified: deadline March 27 confirmed (verbatim), Airtable form URL active in page source, homepage unchanged (same team, same publications). No new announcements or requirement changes. Joel Lehman email still unrecorded — **7th consecutive check without action — CRISIS ESCALATION**. T-3 days to March 10 reference window close. last_researched: 2026-03-07, next_research: 2026-03-10 unchanged. |
| 2026-03-07 | Biber (subagent, T-20 days) | Early urgency check. Live-verified: deadline March 27 confirmed, form open, homepage unchanged. Web search API down (Brave 422). Joel Lehman email still unrecorded — 6th consecutive check without action. Updated last_researched → 2026-03-07, next_research → 2026-03-10. |
